  ...
  return (
    <SoMeSection className="grid section">
      <header className="grid-col-all">
        <h1>Social Media</h1>
        <h2>Stay tuned for updates and upcoming NFTs</h2>
      </header>
      <div className="grid-col-all">
        <ul className="soMeLinks center">

          <SoMeLinksStyle color="#999" colorHover="#00acee">
            <a target="_blank" rel="noopener noreferrer" href="https://twitter.com/vanchoy1">
              <FontAwesomeIcon icon={brands('twitter')} size="3x" />
            </a>
          </SoMeLinksStyle>

          <SoMeLinksStyle color="#999" colorHover="#8a3ab9">
            <a target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/vankatastoyanov/">
              <FontAwesomeIcon icon={brands('instagram')} size="3x" />
            </a>
          </SoMeLinksStyle>

          <SoMeLinksStyle color="#999" colorHover="#FF0000">
            <a target="_blank" rel="noopener noreferrer" href="https://www.youtube.com/channel/UCnDHoczNtjpsqrvqtaowCcw">
              <FontAwesomeIcon icon={brands('youtube')} size="3x" />
            </a>
          </SoMeLinksStyle>

          <SoMeLinksStyle color="#999" colorHover="#5865F2">
            <a target="_blank" rel="noopener noreferrer" href="https://discordapp.com/users/vanchoy#1244">
